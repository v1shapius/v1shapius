...
### Другие настройки
- **Штраф за рестарт**: Настраиваемое время штрафа (по умолчанию 30 секунд)
...
- `/setup_channels` - Интерактивная настройка каналов
...
5. **Выбор первого**: Определение кто играет первым
